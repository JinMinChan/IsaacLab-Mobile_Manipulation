...
class CameraFrankaEnv(DirectRLEnv):
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        ...
        self.robot_dof_targets[:, 3] = 0.0 
        self.robot_dof_targets[:, 4] = 0.0 
        self.robot_dof_targets[:, 5] = 0.0 
        self.robot_dof_targets[:, 6] = 0.0 
        #self.robot_dof_targets[:, 7] = 0.0 
        #self.robot_dof_targets[:, 8] = 0.0 
        #self.robot_dof_targets[:, 9] = 0.0 
